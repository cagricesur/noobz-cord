/** Cookie names for remembered conference devices (deviceId only; not mic/cam on/off). */
export const COOKIE_CONFERENCE_MIC_DEVICE = "nc-conf-mic-device";
export const COOKIE_CONFERENCE_CAM_DEVICE = "nc-conf-cam-device";
export const COOKIE_CONFERENCE_AUDIO_OUTPUT_DEVICE = "nc-conf-audio-out-device";
